...
<html lang="en">
<head>
    <title>Code coverage report for file-manager-js/lib/list/fn.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">file-manager-js/lib/list/</a> fn.js
    </h1>
    <div class='clearfix'>
  ...
  const addEntry = p =&gt; stat(p)
    .then((stats) =&gt; {
      if (stats.isDirectory()) {
        entries.dirs.push(p);
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (stats.isFile()) {
